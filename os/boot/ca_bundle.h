 ...
 *
 * Mozilla CA Certificate Store (full set, sourced from
 * https://curl.se/ca/cacert.pem). Sufficient to verify TLS server
 * certs from essentially any public CA. ~250 KB of PEM data.
 *
 * To regenerate: re-fetch curl.se/ca/cacert.pem and run the
 * generator script in this commit's message.
 *
 * Public certificates only. No secrets.
 */
