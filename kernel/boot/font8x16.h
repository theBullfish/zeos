/*
 * font8x16.h — VGA-style 8x16 bitmap font for Zeos
 *
 * Classic IBM VGA ROM font (CP437 compatible, ASCII subset).
 * 128 characters, 8 pixels wide, 16 pixels tall.
 * Each character is 16 consecutive bytes; one byte per row, MSB = leftmost pixel.
 * Public domain — these bitmaps have shipped in PC BIOSes since the 1980s.
 */
