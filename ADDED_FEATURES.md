...
| 2026-05-05 | specs/OPT_IN_TEST_REPORTING.md + foundational-programs cross-link — Zeos ships with a deep per-layer self-test suite that, with user opt-in, sends anonymized reports back to Codex Labs (us); P0 in §11 of FOUNDATIONAL_PROGRAMS | (pending push) |
