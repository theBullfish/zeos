...
| 2026-05-05 | tools/zplus type-shape + semantic-contracts spec — src/ty.rs (Type enum + UnitTag), SEMANTIC_CONTRACTS.md enumerating each of the 28 synthetic __op__ callees with type signature and runtime contract; 9 new ty unit tests; 83 tests green | (pending push) |
